...
import com.gloria.moringacrud.dataLayer.repositories.UserReopsitory;
...
public class UserServiceImpl implements UserDetailsService, UserService {
    ...
    public List<User> findAll() {
        ...
        userReopsitory.findAll().iterator().forEachRemaining(list::add);
        return list;
    }
    ...
    public User save(UserDto user) {
        ...
        return userReopsitory.save(nUser);
    }
}
